...
class ShippingView extends ViewModelBuilderWidget<ShippingViewModel> {
  ...
  @override
  Widget builder(BuildContext context, ShippingViewModel viewModel, Widget? child) {
      ...
      body: Form(
        child: Builder(
          builder: (context) {
            return Column(
              children: [
                CustomizedAppBar(title: "Checkout",
  ...
  @override
  ShippingViewModel viewModelBuilder(BuildContext context) => ShippingViewModel();
